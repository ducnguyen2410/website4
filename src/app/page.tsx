...
import website2_logo from "../../public/website2_logo.jpg";
import website2_banner from "../../public/website2_banner.jpg";
import m1 from "../../public/website2_1.jpg"
  ...
  return (
    <div className="w-full h-screen overflow-auto flex flex-col items-center">
      <div className="mt-20 items-center gap-10 flex flex-col">
        <span className="text-[3rem] text-white">$DIGLETT</span>
        <Image
          src={website2_banner}
          alt=""
      ...
      <div className="flex flex-col gap-5 mt-20 items-center">
        ...
        <span className="font-[600] text-white">Most memeable pokemon</span>
      </div>
      <div className="flex flex-row mt-20 gap-10">
        <Image  src={m1} alt="" width={400}/>
        <Image  src={m2} alt="" width={400}/>
      </div>
